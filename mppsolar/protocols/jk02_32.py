...
NEW_COMMANDS = {
    "getCellData": {
        ...
        "response": [
            ...
            ["LittleHex2Int:r/1000", 4, "Battery_Current", "A"],  # signed int32
            # ["discard", 8, "discard3", ""],
            ["LittleHex2Short:r/10", 2, "Battery_T1", "°C"],
            ["LittleHex2Short:r/10", 2, "Battery_T2", "°C"],
            # ["LittleHex2Short:r/10", 2, "MOS_Temp", "°C"],
            ["discard", 4, "discard4", ""],  # discard4
            ["LittleHex2Short:r/1000", 2, "Balance_Current", "A"],  # added
            ["discard", 1, "discard5", ""],
            ...
            ["discard", 2, "Unknown19", ""],
            ["discard", 2, "Unknown20", ""],
            ["discard", 2, "Unknown21", ""],  # Unknown21
            ["discard", 2, "Unknown22", ""],  # Unknown22
            ["discard", 2, "Unknown23", ""],
            ["discard", 2, "Unknown24", ""],
            ["discard", 2, "Unknown25", ""],
            ["discard", 2, "Unknown26", ""],
...
class jk02_32(jkAbstractProtocol):
    """
    JK02_32 - Handler for JKBMS 2 byte data communication
         - e.g. ASAS = ??V
    """

    def __str__(self):
        return "JK02 - JKBMS BLE 2 byte data communication protocol handler for 32 cell response"

    def __init__(self, *args, **kwargs) -> None:
        super().__init__()
        self._protocol_id = b"JK02_32"
