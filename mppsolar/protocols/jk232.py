...
COMMANDS = {
    "getBalancerData": {
        ...
        "response": [
            ...
            ["Big2ByteHex2Int:r/100", 2, "Total Battery Voltage", "V"],
            ["Big2ByteHex2Int:r/100", 2, "Total Current", "A"],
            ["Big2ByteHex2Int:r/100", 2, "Remaining Capacity", "Ah"],
            ["Big2ByteHex2Int:r/100", 2, "Nominal Capacity", "Ah"],
            ["Big2ByteHex2Int", 2, "Cycles", "cycles"],
