...
class test_pi30revo(unittest.TestCase):
    ...
    def test_get_full_command_pset(self):
        """ test for full command generation for pset"""
        result = protocol.get_full_command("PSET120103 56.3 54.6 43.8 42.6 040 020 2020 02 18 17 06 00")
        expected = b"PSET120103 56.3 54.6 43.8 42.6 040 020 2020 02 18 17 06 00\xf6\r"
        # print(result)
        # print(expected)
        self.assertEqual(expected, result)

    def test_get_full_command_pset_no_nl(self):
        """ test for full command generation for pset with no new line"""
        result = protocol.get_full_command("_PSET120103 56.3 54.6 43.8 42.6 040 020 2020 02 18 17 06 00")
        expected = b"PSET120103 56.3 54.6 43.8 42.6 040 020 2020 02 18 17 06 00\xf6"
        # print(result)
        # print(expected)
        self.assertEqual(expected, result)
