...
SOURCE_PRIORITY_LIST = ["undefined", "Solar first", "Solar + Utility", "Only Solar"]
...
QUERY_COMMANDS = {
    ...
    "QVFW3": {
        ...
        "result_type": ResultType.SINGLE,
        "reading_definitions": [{"description": "Remote CPU firmware version",
                                    "reading_type": ReadingType.MESSAGE, "icon": "mdi:identifier",
    ...
    "VERFW": {
        ...
        "result_type": ResultType.SINGLE,
        "reading_definitions": [{"description": "Bluetooth firmware version",
                                    "reading_type": ReadingType.MESSAGE, "icon": "mdi:identifier",
                                    "response_type": ResponseType.TEMPLATE_BYTES, "format_template" : "r.removeprefix('VERFW:')"}],
        "test_responses": [b"(VERFW:00072.70\x53\xA7\r", ],
    },
    ...
    "QPIRI": {
        ...
        "reading_definitions": [
            {"description": "AC Input Voltage", "response_type": ResponseType.FLOAT,
                "reading_type": ReadingType.VOLTS, "icon": "mdi:transmission-tower-import", "device-class": "voltage"},
            {"description": "AC Input Current", "response_type":ResponseType.FLOAT,
                "reading_type": ReadingType.CURRENT, "icon": "mdi:current-ac", "device-class": "current"},
    ...
    "QPIGS2": {
        ...
        "reading_definitions": [
            {"description": "PV2 Input Current",
                "reading_type": ReadingType.CURRENT, "icon": "mdi:solar-power", "device-class": "current",
                "response_type": ResponseType.FLOAT},
            {"description": "PV2 Input Voltage",
                "reading_type": ReadingType.VOLTS, "icon": "mdi:solar-power", "device-class": "voltage",
                "response_type": ResponseType.FLOAT},
    ...
    "QPGS": {
        ...
        "reading_definitions": [
            ...
            {"description": "Grid Voltage",
                "reading_type": ReadingType.VOLTS, "icon": "mdi:power-plug", "device-class": "voltage",
                "response_type": ResponseType.FLOAT},
            ...
            {"description": "Battery Capacity",
                "reading_type": ReadingType.PERCENTAGE, "device-class": "battery",
                "response_type": ResponseType.INT},
            {"description": "PV1 Input Voltage",
                "reading_type": ReadingType.VOLTS, "icon": "mdi:solar-power", "device-class": "voltage",
                "response_type": ResponseType.FLOAT},
            {"description": "Total Charging Current",
                "reading_type": ReadingType.CURRENT, "icon": "mdi:brightness-percent", "device-class": "current",
                "response_type": ResponseType.INT},
            ...
            {"description": "Max Charger Current",
                "reading_type": ReadingType.CURRENT, "device-class": "current",
                "response_type": ResponseType.INT},
            {"description": "Max Charger Range",
                "reading_type": ReadingType.CURRENT, "device-class": "current", "response_type": ResponseType.INT},
            {"description": "Max AC Charger Current",
                "reading_type": ReadingType.CURRENT, "device-class": "current", "response_type": ResponseType.INT},
            {"description": "PV1 Input Current",
                "reading_type": ReadingType.CURRENT, "icon": "mdi:solar-power", "device-class": "power",
                "response_type": ResponseType.INT},
            {"description": "Battery Discharge Current",
                "reading_type": ReadingType.CURRENT, "icon": "mdi:battery-negative", "device-class": "current",
                "response_type": ResponseType.INT},
    ...
    "QDI": {
        ...
        "reading_definitions": [
            ...
            {"description": "Output Source Priority",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.LIST,
                "options": ["Utility first", "Solar first", "SBU first"]},
            {"description": "Charger Source Priority",
                "reading_type": ReadingType.MESSAGE,
                "response_type": ResponseType.LIST,
                "options": [
    ...
    "QET": {
        ...
        "reading_definitions": [
            {"description": "Total PV Generated Energy", 
                "reading_type": ReadingType.WATT_HOURS, "icon": "mdi:solar-power", "device-class": "energy", "state_class": "total",
                "response_type": ResponseType.INT}
        ],
        "test_responses": [
            b"(00238800!J\r",
    ...
    "QEY": {
        ...
        "reading_definitions": [
            {"description": "PV Generated Energy for Year", 
                "reading_type": ReadingType.WATT_HOURS, "icon": "mdi:counter", "device-class": "energy", "state_class": "total",
                "response_type": ResponseType.INT},
            {"description": "Year",
    ...
    "QLD": {
        ...
        "result_type": ResultType.ORDERED,
        "reading_definitions": [
            {"description": "Output Load Energy for Day", "icon": "mdi:counter", "device-class": "energy", "state_class": "total",
                "reading_type": ReadingType.WATT_HOURS, 
                "response_type": ResponseType.INT},
            {"description": "Year",
                "reading_type": ReadingType.YEAR, 
                "response_type": ResponseType.INFO_FROM_COMMAND, "format_template": "int(cn[3:7])"},
    ...
    "QOPPT": {
        ...
        "reading_definitions": [
            ...
            {"description": "Selection of Output Source Priority Order 1", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
            {"description": "Selection of Output Source Priority Order 2", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
            {"description": "Selection of Output Source Priority Order 3", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
        ],
        "test_responses": [
    ...
    "QCHPT": {
        ...
        "reading_definitions": [
            ...
            {"description": "Selection of Charger Source Priority Order 1", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
            {"description": "Selection of Charger Source Priority Order 2", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
            {"description": "Selection of Charger Source Priority Order 3", "reading_type": ReadingType.MESSAGE, "response_type": ResponseType.LIST, "options": SOURCE_PRIORITY_LIST},
        ],
        "test_responses": [
