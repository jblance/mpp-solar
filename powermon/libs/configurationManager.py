...
class ConfigurationManager:
    ...
    @staticmethod
    def parseOutputConfig(outputConfig: dict, topic: str, schedule_name: str, device: Device, mqtt_broker: MqttBroker) -> AbstractOutput:
    ...
    def parseControllerConfig(config : dict, device : Device, mqtt_broker : MqttBroker) -> ScheduleController:
        ...
        _name = config["name"]
        _loopDuration = config["loop_duration"]
